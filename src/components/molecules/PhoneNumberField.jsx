  ...
  return (
    <div className='flex gap-1 flex-col'>
      ...
      <div className='h-12 flex gap-2'>
        <div className='flex items-center min-w-0 rounded-lg outline-none border-2 border-[--border-color] justify-between cursor-pointer'>
        ...
        <div className='flex items-center flex-1 min-w-0 rounded-lg outline-none border-2 border-[--border-color] p-3'>
